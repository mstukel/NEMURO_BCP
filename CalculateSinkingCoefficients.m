function[Coeff1,Coeff2,Coeff3]=CalculateSinkingCoefficients(profile,z_int,omega,dt)
...
% profile_new = profile.*Coeff1 + [zeros(1,length(omega));profile(1:end-1,:)].*Coeff2;
% 
% Flux=profile.*Coeff3;
